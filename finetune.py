...
if __name__ == "__main__":
    ...
    # 节约时间，仅测试一个
    parser.add_argument(
        "-t", "--target", help="verification targets", default="lfw", type=str
    )
    ...
    if BACKBONE_RESUME_ROOT:
        ...
        print("=" * 60)
    del BACKBONE.enc_to_dec
    del BACKBONE.mask_token
    del BACKBONE.decoder
    del BACKBONE.decoder_pos_emb
    del BACKBONE.to_pixels
    ...
    for epoch in range(NUM_EPOCH):  # start training process
        ...
        for inputs, labels in iter(trainloader):
            ...
            outputs, _ = BACKBONE(inputs.float(), labels, is_finetune=True)
